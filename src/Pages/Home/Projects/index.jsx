...
function Projects() {
    return (
        <>
        <section id='Projects' className='flex flex-col flex-nowrap items-center justify-center gap-[15px] w-full h-auto py-[30px] dark:bg-slate bg-white rounded-b-[30px]'>
            ...
            <div className='snap-proximity snap-x overflow-x-scroll scroll-pl-[20px] flex flex-row flex-nowrap justify-start items-center gap-[20px] w-full h-auto px-[20px]'>
                ...
                <BoxProject Title='Levaê' Paragraph='Uma empresa mudança, Toda sua identidade criada para compor experiência.' Link='https://levae.netlify.app'/>
